...
from VariantBiCriteriaProbReaderOR import VariantBiCriteriaProbReaderOR
...
if __name__ == "__main__":
    ...
    reader = VariantBiCriteriaProbReaderOR(inputPath)
    reader.load()
    ...
    print("RQ1Config4.py is being imported into another module")
